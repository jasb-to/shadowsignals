...
const FALLBACK_TOKENS: Record<string, CryptoToken> = {
  ...
  ai16z: {
    ...
    ath: 0.45,
    ath_change_percentage: -72.2,
    ath_date: "2024-12-15T10:30:00.000Z",
    atl: 0.08,
    atl_change_percentage: 56.25,
    atl_date: "2024-11-20T08:15:00.000Z",
    last_updated: new Date().toISOString(),
    image: "/placeholder.svg?height=64&width=64",
  },
  ethereum: {
    ...
    max_supply: null,
    ath: 4878,
    ath_change_percentage: -42.6,
    ath_date: "2021-11-10T14:24:11.849Z",
    atl: 0.43,
    atl_change_percentage: 651063.0,
